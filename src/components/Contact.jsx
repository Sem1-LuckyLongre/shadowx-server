      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        >
          ...
          <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto text-lg">
            ...
            We're here to help you connect and provide the best support possible.
          </p>
        </motion.div>
            ...
            <div className="space-y-6">
              {[
                ...
                },
                {
                  ...
                  title: 'Address',
                  content: 'DUMMY ADDRESS:- 123 Innovation Avenue, ShadowX, 54321'
                }
              ].map((contact, index) => (
                <motion.div 
                  key={index}
                ...
                >
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-blue-600 dark:text-blue-300">{contact.title}</h3>
